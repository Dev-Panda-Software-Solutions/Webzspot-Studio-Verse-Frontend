...
export const grantFreeAccess = (id, data) => api.put(`/tenants/${id}/free-access`, data)
export const revokeFreeAccess = (id) => api.delete(`/tenants/${id}/free-access`)
export const setTenantPlan = (id, data) => api.put(`/tenants/${id}/plan`, data)
